...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean isValidLogin(String nim, String password) {
        ...
        //MODE_PRIVATE artinya data ini hanya dapat diakses oleh aplikasi yang sama
        SharedPreferences sharedPreferences = getSharedPreferences("user_pref", MODE_PRIVATE); //Mengembalikan objek SharedPreferences yang disebut "user_pref"
        //mengambil nilai dari sharepref, klo tdk ada akan mengembalikan string kosong
        String storedPassword = sharedPreferences.getString("password", "");
        String storedNim = sharedPreferences.getString("nim", "");

        return storedNim.equals(nim) && storedPassword.equals(password);//keduanya mengembalikan true jika pass dan nim benar
    }
