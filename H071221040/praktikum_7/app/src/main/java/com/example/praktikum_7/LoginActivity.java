...
public class LoginActivity extends AppCompatActivity {
    ...
    private void saveLoginStatus(boolean isLoggedIn) {
        ...
        SharedPreferences.Editor editor = sharedPreferences.edit();//knp perlu editor?
        editor.putBoolean("isLoggedIn", isLoggedIn); //Menyimpan nilai boolean ke SharedPreferences dengan kunci "isLoggedIn".
        editor.apply();
    }
}
