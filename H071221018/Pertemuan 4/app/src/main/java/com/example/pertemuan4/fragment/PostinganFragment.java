    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_posting.setOnClickListener(btn ->{
            ...
            if (konten.isEmpty()) {
                ...
                Instagram instagram = new Instagram("rrq_vynnn", "vyn", konten, R.drawable.vyn, selectedImageUri);
                ...
                fragmentManager.beginTransaction()
                        ...
                        .addToBackStack(null)
                        .commit();
                Toast.makeText(getActivity(),"Postingan berhasil di tambahkan", Toast.LENGTH_SHORT).show();
            } else {
