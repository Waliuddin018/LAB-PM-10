...
// penghubung antara data dari objek Instagram dengan tampilan RecyclerView,
// dan menangani interaksi pengguna kayak hapus postingan dan tampilkan profil pengguna
            ...
            builder.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    if (adapterPosition != RecyclerView.NO_POSITION) {
                        ...
                        Toast.makeText(holder.context, "Berhasil menghapus postingan", Toast.LENGTH_SHORT).show();
                    }
                }
            });
