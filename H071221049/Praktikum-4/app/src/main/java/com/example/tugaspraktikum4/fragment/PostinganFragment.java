...
// Menampilkan tampilan postingan baru dan mengelola proses membuat postingan baru
...
public class PostinganFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_posting.setOnClickListener(btn ->{
            ...
            Instagram instagram = new Instagram("Chizunoya", "Chizu", konten, R.drawable.img1, selectedImageUri);

            Bundle bundle = new Bundle();
            bundle.putParcelable(HomeFragment.EXTRA_INSTAGRAM, instagram);
            Toast.makeText(getActivity(), "Berhasil mengupload", Toast.LENGTH_SHORT).show();
