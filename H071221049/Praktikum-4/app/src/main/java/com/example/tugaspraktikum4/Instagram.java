...
// Merepresentasikan data sebuah postingan Instagram
...
public class Instagram implements Parcelable {
    ...
    public Instagram(String username, String name, String konten, int wony, Uri selectedImageUri) {
        this.username = username;
        this.name = name;
        this.desc = konten;
        this.fotoProfile = wony;
