...
public class Instagram implements Parcelable {
    ...
    public Instagram(String uname, String nama, String konten, int satu, Uri selectedImageUri) {
        this.username = uname;
        this.name = nama;
        this.desc = konten;
    ...
    public static final Creator<Instagram> CREATOR = new Creator<Instagram>() {
        // objek Instagram dikirimkan melalui Intent atau disimpan ke dalam Bundle
        @Override
