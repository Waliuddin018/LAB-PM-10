...
// Mengelola pembuatan dan penguploadan postingan baru
...
public class PostinganFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Memilih/mengambil gambar dari galeri
        ...
        // Ketika button diklik, konten dari EditText diambil
        btn_posting.setOnClickListener(btn ->{
            ...
            if (konten.isEmpty()) {
                ...
                Instagram instagram = new Instagram("Chizushen", "Chizu", konten, R.drawable.lucy, selectedImageUri);
