...
public class SeacrhAdapter extends RecyclerView.Adapter<SeacrhAdapter.ViewHolder> {
    ...
    // Menetapkan data dari objek Instagram ke ViewHolder
    @Override
    ...
    //  Memperbarui daftar objek Instagram yang ditampilkan
    //  di RecyclerView setelah proses filter dilakukan
    ...
    // Menyimpan referensi ke komponen-komponen UI yang ada
    // dalam setiap item dalam RecyclerView
