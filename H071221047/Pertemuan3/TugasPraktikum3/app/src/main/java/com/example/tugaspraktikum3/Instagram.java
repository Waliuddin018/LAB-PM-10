...
public class Instagram implements Parcelable {
    ...
    public Instagram(String nama, String caption, Integer imageprofile, Integer imagefeed, Integer imagestory, Integer followers, Integer following) {
        this.nama = nama;
    ...
    public static final Creator<Instagram> CREATOR = new Creator<Instagram>() {
        ...
        @Override
        public Instagram[] newArray(int size) { return new Instagram[size] ; }
    };
