...
public class SearchFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Mengatur listener untuk SearchView yg nanti akan tangani perubahan teks pencarian
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                //Selama pencarian berlangsung, ProgressBar ditampilkan,
                // dan RecyclerView disembunyikan.
    ...
    private void filterList(String text) {
        ...
        for (Post post : DataSource.posts) {
            if (post.getNama().toLowerCase().contains(text.toLowerCase())) {
