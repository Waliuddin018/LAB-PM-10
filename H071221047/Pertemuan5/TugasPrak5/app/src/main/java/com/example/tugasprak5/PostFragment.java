...
import static com.example.tugasprak4.DataSource.posts;
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!konten.isEmpty() && selectedImage != null) {
                    Post newModel = new Post("Blair Willows", "Blair_Willows", konten, R.drawable.pp_barbie_charm, selectedImage);
